...
import ${basepackage}.bean.${classNameLowerCase}.${className};
...
public class ${className}DaoImpl extends BaseSessionDaoSupport implements ${className}Dao{
	...
	public int insert(${className} ${classNameLower}) {
		...
		return super.getSqlSession().update("${className}.insert", ${classNameLower});
	}
	@Override
	public int insertBatch(List<${className}> list) {
		...
		for (${className} ${classNameLower} : list) {
			count += super.getSqlSession().update("${className}.insert", ${classNameLower});
		}
		return count;
	}
	...
	public int update(${className} ${classNameLower}) {
		// TODO Auto-generated method stub
		return super.getSqlSession().update("${className}.update", ${classNameLower});
	}
